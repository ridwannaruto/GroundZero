...
class submissionController extends Controller
{
    public function projectsubmissionAction(Request $request)
    {
        ...
        try{
            ...
            return $this->render('VolunteerManagementSystemProjectBundle:Submission:projectsubmission.html.twig', array('id' => $id,'form' => $form->createView()));
        }

        return $this->redirect($this->generateUrl('confirmproject_creation',array('id'=>$id)));
        }
